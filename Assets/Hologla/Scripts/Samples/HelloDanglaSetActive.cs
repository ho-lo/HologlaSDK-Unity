...
public class HelloDanglaSetActive : MonoBehaviour {
	...
	public void SpawnMovableTrue(GameObject spawnTransObj)
	{
		//メニューを開いている場合は何もしない.
		if( true == IsOpenMenu( ) ){
			return;
...
*/
	...
	public void SpawnMovableFalse(GameObject spawnTransObj)
	{
		//メニューを開いている場合は何もしない.
		if( true == IsOpenMenu( ) ){
			return;
